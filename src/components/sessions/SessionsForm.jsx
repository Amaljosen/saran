...
function SessionForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(
        "Response",
        response,"Response Data",response.data.order
      );
      ...
      if (response.status === 200) {
        ...
        const options = {
          ...
          handler: async function (response) {
            ...
            const paymentId= await axios.post(`${import.meta.env.VITE_BACKEND_API}/v1/link`,{
    ...
    <div>
      <div className="container mx-auto mt-32">
        <div className="w-full lg:w-[90%] mx-auto p-4">
          ...
          {/* Stepper Component - Similar to previous form */}
          <div className="pt-8">
          ...
          {/* Progress Tracking - Similar to previous form */}
           {/* Tracker Line */}
          ...
          {/* ... (keep the existing progress tracking code) ... */}
          ...
          >
              ...
              <div className={`${kit === "Not Provided"?'md:grid-cols-1 md:w-[70%] mx-auto':'md:grid-cols-2 lg:gap-10'} grid text-md lg:text-lg py-4 gap-3 `}>
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className={`outline-none w-full p-2 rounded-md border ${kit==='Not Provided'?'hidden':'block'}`}
                  />
                </div>
                <div className="space-y-3">
                  <input
                ...
                <div className="w-full lg:w-[80%] mx-auto">
                  <div className="border lg:p-5 p-4 rounded-md">
                    ...
                    <ul className="space-y-2 mt-2 text-gray-500 text-sm md:text-base">
                      <li>1. Full Length Image {`(To be used as main picture)`}</li>
                      <li>2. Only allow specific formats like JPEG, PNG, or WebP for uploading.</li>
                      <li>3. The image size should not exceed a specific limit (e.g., 5 MB).</li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="w-full lg:w-[80%] mx-auto border mt-8 p-4 rounded-md relative">
              ...
              <div>
                <div className="grid lg:grid-cols-2 grid-cols-1 lg:px-5 py-1 lg:py-4 lg:gap-5">
                  <div className="lg:border rounded-md p-3 md:p-5 space-y-2 border-[#E8EAED]">
